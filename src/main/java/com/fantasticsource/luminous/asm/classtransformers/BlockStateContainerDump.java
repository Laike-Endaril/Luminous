...
public class BlockStateContainerDump implements Opcodes
{
    public static byte[] dump()
    {
        ...
        cw.visitInnerClass("net/minecraft/block/state/BlockStateContainer$StateImplementation", "net/minecraft/block/state/BlockStateContainer", "StateImplementation", ACC_PUBLIC + ACC_STATIC);
        ...
        {
            fv = cw.visitField(ACC_PRIVATE + ACC_FINAL + ACC_STATIC, "NAME_PATTERN", "Ljava/util/regex/Pattern;", null, null);
            fv.visitEnd();
        }
        {
            fv = cw.visitField(ACC_PRIVATE + ACC_FINAL + ACC_STATIC, "GET_NAME_FUNC", "Lcom/google/common/base/Function;", "Lcom/google/common/base/Function<Lnet/minecraft/block/properties/IProperty<*>;Ljava/lang/String;>;", null);
            fv.visitEnd();
        }
        {
            fv = cw.visitField(ACC_PRIVATE + ACC_FINAL, "block", "Lnet/minecraft/block/Block;", null, null);
            fv.visitEnd();
        }
        {
            fv = cw.visitField(ACC_PRIVATE + ACC_FINAL, "properties", "Lcom/google/common/collect/ImmutableSortedMap;", "Lcom/google/common/collect/ImmutableSortedMap<Ljava/lang/String;Lnet/minecraft/block/properties/IProperty<*>;>;", null);
            fv.visitEnd();
        }
        {
            fv = cw.visitField(ACC_PRIVATE + ACC_FINAL, "validStates", "Lcom/google/common/collect/ImmutableList;", "Lcom/google/common/collect/ImmutableList<Lnet/minecraft/block/state/IBlockState;>;", null);
            fv.visitEnd();
        }
        {
        ...
        }
        {
            ...
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 1);
            mv.visitFieldInsn(PUTFIELD, "net/minecraft/block/state/BlockStateContainer", "block", "Lnet/minecraft/block/Block;");
            ...
            mv.visitMethodInsn(INVOKESTATIC, "net/minecraft/block/state/BlockStateContainer", "validateProperty", "(Lnet/minecraft/block/Block;Lnet/minecraft/block/properties/IProperty;)Ljava/lang/String;", false);
            mv.visitInsn(POP);
            mv.visitVarInsn(ALOAD, 4);
            mv.visitVarInsn(ALOAD, 8);
            mv.visitMethodInsn(INVOKEINTERFACE, "net/minecraft/block/properties/IProperty", "getName", "()Ljava/lang/String;", true);
            mv.visitVarInsn(ALOAD, 8);
            ...
            mv.visitFieldInsn(PUTFIELD, "net/minecraft/block/state/BlockStateContainer", "properties", "Lcom/google/common/collect/ImmutableSortedMap;");
            ...
            mv.visitVarInsn(ALOAD, 0);
            mv.visitMethodInsn(INVOKESPECIAL, "net/minecraft/block/state/BlockStateContainer", "getAllowedValues", "()Ljava/util/List;", false);
            mv.visitMethodInsn(INVOKESTATIC, "net/minecraft/util/math/Cartesian", "cartesianProduct", "(Ljava/lang/Iterable;)Ljava/lang/Iterable;", false);
            ...
            mv.visitVarInsn(ASTORE, 8);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "net/minecraft/block/state/BlockStateContainer", "properties", "Lcom/google/common/collect/ImmutableSortedMap;");
            ...
            mv.visitVarInsn(ALOAD, 8);
            mv.visitMethodInsn(INVOKESTATIC, "net/minecraft/util/MapPopulator", "createMap", "(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/Map;", false);
            ...
            mv.visitVarInsn(ALOAD, 8);
            mv.visitVarInsn(ALOAD, 5);
            mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/block/state/BlockStateContainer$StateImplementation", "buildPropertyValueTable", "(Ljava/util/Map;)V", false);
            ...
            mv.visitFieldInsn(PUTFIELD, "net/minecraft/block/state/BlockStateContainer", "validStates", "Lcom/google/common/collect/ImmutableList;");
            mv.visitInsn(RETURN);
            mv.visitMaxs(4, 11);
            mv.visitEnd();
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "validateProperty", "(Lnet/minecraft/block/Block;Lnet/minecraft/block/properties/IProperty;)Ljava/lang/String;", "<T::Ljava/lang/Comparable<TT;>;>(Lnet/minecraft/block/Block;Lnet/minecraft/block/properties/IProperty<TT;>;)Ljava/lang/String;", null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 1);
            mv.visitMethodInsn(INVOKEINTERFACE, "net/minecraft/block/properties/IProperty", "getName", "()Ljava/lang/String;", true);
            mv.visitVarInsn(ASTORE, 2);
            mv.visitFieldInsn(GETSTATIC, "net/minecraft/block/state/BlockStateContainer", "NAME_PATTERN", "Ljava/util/regex/Pattern;");
            mv.visitVarInsn(ALOAD, 2);
            ...
            mv.visitVarInsn(ALOAD, 1);
            mv.visitMethodInsn(INVOKEINTERFACE, "net/minecraft/block/properties/IProperty", "getAllowedValues", "()Ljava/util/Collection;", true);
            ...
            mv.visitVarInsn(ALOAD, 1);
            mv.visitVarInsn(ALOAD, 4);
            mv.visitMethodInsn(INVOKEINTERFACE, "net/minecraft/block/properties/IProperty", "getName", "(Ljava/lang/Comparable;)Ljava/lang/String;", true);
            mv.visitVarInsn(ASTORE, 5);
            mv.visitFieldInsn(GETSTATIC, "net/minecraft/block/state/BlockStateContainer", "NAME_PATTERN", "Ljava/util/regex/Pattern;");
            mv.visitVarInsn(ALOAD, 5);
            mv.visitMethodInsn(INVOKEVIRTUAL, "java/util/regex/Pattern", "matcher", "(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;", false);
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getValidStates", "()Lcom/google/common/collect/ImmutableList;", "()Lcom/google/common/collect/ImmutableList<Lnet/minecraft/block/state/IBlockState;>;", null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "net/minecraft/block/state/BlockStateContainer", "validStates", "Lcom/google/common/collect/ImmutableList;");
            mv.visitInsn(ARETURN);
            mv.visitMaxs(1, 1);
            mv.visitEnd();
        }
        {
            mv = cw.visitMethod(ACC_PRIVATE, "getAllowedValues", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/Iterable<Ljava/lang/Comparable<*>;>;>;", null);
            mv.visitCode();
            mv.visitMethodInsn(INVOKESTATIC, "com/google/common/collect/Lists", "newArrayList", "()Ljava/util/ArrayList;", false);
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getBaseState", "()Lnet/minecraft/block/state/IBlockState;", null, null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "net/minecraft/block/state/BlockStateContainer", "validStates", "Lcom/google/common/collect/ImmutableList;");
            mv.visitInsn(ICONST_0);
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getBlock", "()Lnet/minecraft/block/Block;", null, null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "net/minecraft/block/state/BlockStateContainer", "block", "Lnet/minecraft/block/Block;");
            mv.visitInsn(ARETURN);
            mv.visitMaxs(1, 1);
            mv.visitEnd();
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getProperties", "()Ljava/util/Collection;", "()Ljava/util/Collection<Lnet/minecraft/block/properties/IProperty<*>;>;", null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "net/minecraft/block/state/BlockStateContainer", "properties", "Lcom/google/common/collect/ImmutableSortedMap;");
            mv.visitMethodInsn(INVOKEVIRTUAL, "com/google/common/collect/ImmutableSortedMap", "values", "()Lcom/google/common/collect/ImmutableCollection;", false);
        ...
        }
        {
            ...
            mv.visitLdcInsn("block");
            mv.visitFieldInsn(GETSTATIC, "net/minecraft/block/Block", "REGISTRY", "Lnet/minecraft/util/registry/RegistryNamespacedDefaultedByKey;");
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "net/minecraft/block/state/BlockStateContainer", "block", "Lnet/minecraft/block/Block;");
            mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/util/registry/RegistryNamespacedDefaultedByKey", "getNameForObject", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
            ...
            mv.visitFieldInsn(GETFIELD, "net/minecraft/block/state/BlockStateContainer", "properties", "Lcom/google/common/collect/ImmutableSortedMap;");
            mv.visitMethodInsn(INVOKEVIRTUAL, "com/google/common/collect/ImmutableSortedMap", "values", "()Lcom/google/common/collect/ImmutableCollection;", false);
            mv.visitFieldInsn(GETSTATIC, "net/minecraft/block/state/BlockStateContainer", "GET_NAME_FUNC", "Lcom/google/common/base/Function;");
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getProperty", "(Ljava/lang/String;)Lnet/minecraft/block/properties/IProperty;", "(Ljava/lang/String;)Lnet/minecraft/block/properties/IProperty<*>;", null);
            {
        ...
        }
        {
            ...
            mv.visitFieldInsn(PUTSTATIC, "net/minecraft/block/state/BlockStateContainer", "NAME_PATTERN", "Ljava/util/regex/Pattern;");
            ...
            mv.visitFieldInsn(PUTSTATIC, "net/minecraft/block/state/BlockStateContainer", "GET_NAME_FUNC", "Lcom/google/common/base/Function;");
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 0);
            mv.visitEnd();
        }
